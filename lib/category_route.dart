...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  Widget _buildCategoryWidgets(Orientation deviceOrientation) { //Added el "orientation" argument
    if (deviceOrientation == Orientation.portrait) { //Added to set view in portrait mode (category widget)
      return ListView.builder( //En portrait usamos un listview
  ...
  Widget build(BuildContext context) {
    ...
    final listView = Padding(
      ...
      child: _buildCategoryWidgets(MediaQuery.of(context).orientation), //Added use of MediaQuery to pass current orientation of the device
    );
